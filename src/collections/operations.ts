...
export const Bookings: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "providerCode", type: "text", required: true },
    { name: "providerReference", type: "text" },
    { name: "slotId", type: "text", required: true },
    { name: "participants", type: "number", required: true, min: 1 },
    {
      name: "status",
      type: "select",
      required: true,
...
export const Payments: CollectionConfig = {
  slug: "payments",
  access: privateAccess,
  admin: { useAsTitle: "externalPaymentId" },
  fields: [
    {
      name: "booking",
      type: "relationship",
    ...
    { name: "externalPaymentId", type: "text", unique: true, index: true },
    { name: "amountMinor", type: "number", required: true, min: 0 },
    { name: "currency", type: "select", options: ["EUR"], required: true },
    {
      name: "status",
      type: "select",
      required: true,
...
export const ProcessedWebhookEvents: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "provider", type: "select", options: ["stripe"], required: true },
