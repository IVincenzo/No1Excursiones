  ...
  return (
    <main id="main-content">
      <Hero
        ...
        eyebrow={hero?.eyebrow ?? t.contactEyebrow}
        title={hero?.title ?? t.contactHeroTitle}
        text={hero?.text ?? t.contactHeroText}
      />
          ...
          <div className="row g-4">
            <div className="col-lg-5">
              <p className="section-kicker">
                {primary?.kicker ?? t.contactDetails}
              </p>
              <h2>{primary?.title ?? t.contactSectionTitle}</h2>
            ...
            <div className="col-lg-7">
              <DemoForm className="contact-panel" message={t.formResult}>
                <div className="demo-notice mb-3">
